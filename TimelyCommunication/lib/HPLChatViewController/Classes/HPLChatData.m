...
{
    if(self.type != ChatTypeMine) return;
    UIView *statusView;
    ...
    switch (messageStatus) {
        ...
        case ChatStatusFailed: {
            ...
            break;
        case ChatStatusSucceeded:
        {
            UILabel *msg = [[UILabel alloc]initWithFrame:CGRectMake(1.0f, 1.0f, 20.f, 18.f)];
            msg.font = [UIFont systemFontOfSize:10.f];
            msg.text = @"送达";
            msg.textColor = [UIColor lightGrayColor];
            [statusView addSubview:msg];
        }
            break;
        case ChatStatusSended:
        {
            UILabel *msg = [[UILabel alloc]initWithFrame:CGRectMake(1.0f, 1.0f, 20.f, 18.f)];
            msg.font = [UIFont systemFontOfSize:10.f];
            msg.text = @"送出";
